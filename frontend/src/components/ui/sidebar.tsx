			...
			<TooltipProvider delayDuration={0}>
				<div
					...
					style={
						...
						className={cn(
							"group/sidebar-wrapper relative flex h-full min-h-0 w-full overflow-hidden bg-canvas",
							className
						)}
					{...props}
				>
	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					"absolute inset-y-0 z-20 hidden h-full w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear lg:flex",
					side === "left"
