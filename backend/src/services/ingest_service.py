    ...
    def _ensure_active_embedding_profile(self) -> SQLEmbeddingProfile | None:
        ...
        if profile is None:
            profile = SQLEmbeddingProfile(
                ...
                base_url=self.embedder.resource_name,
                model_id=self.embedder.model,
                target_kind=self.embedder.target.target_kind,
                resource_name=self.embedder.target.resource_name,
                google_project_id=self.embedder.google_project_id,
                google_location=self.embedder.google_location,
                adapter_family=self.embedder.target.adapter_family,
